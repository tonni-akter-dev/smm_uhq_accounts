                    ...
                    <div className='overflow-x-auto'>
                        <table className='w-full'>
                            ...
                            <tbody className='divide-y divide-border'>
                                {/* First TELEGRAM MEMBERS / FAST row */}
                                <tr className='bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:bg-indigo-700 transition-colors'>
                                    ...
                                    <td className='px-6 py-4 whitespace-nowrap'>
                                        <div className='flex items-center space-x-2'>
                                            <Button
                                                variant='ghost'
                                                size='icon'
                                                className='h-8 w-8 text-white hover:text-yellow-300 hover:bg-yellow-900/20'
                                            >
                                            ...
                                            <Button
                                                variant='ghost'
                                                size='icon'
                                                className='h-8 w-8 text-white hover:text-red-300 hover:bg-red-900/20'
                                            >
