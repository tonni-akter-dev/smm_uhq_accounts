...
export function ChildPanels() {
  const handleExport = () => {
    console.log('Export child panels data');
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6 lg:space-y-10 relative z-50 bg-gray-50 dark:bg-transparent min-h-screen">
      ...
      <div className='h-[58px] relative'>
        ...
        <input 
          type="text" 
          className='bg-white dark:bg-[#FFFFFF0D] border border-gray-500 dark:border-transparent grad_border1 px-12 w-full focus:outline-0 h-[58px] rounded-[5px] text-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400' 
          placeholder='Search' 
        />
      </div>
      {/* Users Table */}
      <Card className="p-0 bg-white border border-gray-200 dark:border-gray-700 shadow-sm">
        <div className='pt-6 flex justify-between px-4 mb-4'>
          <p className='text-xl text-black! dark:text-white!'>Child Panels</p>
          <button 
