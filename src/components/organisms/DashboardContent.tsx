  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:gap-8">
    {metricsData.map((metric, index) => {
      ...
      return (
        <Card
          key={index}
          className="card-hover border-gray-700 bg-gray-800 transition-transform duration-300 hover:scale-[1.02]"
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-300 sm:text-base">
              {metric.title}
            </CardTitle>
